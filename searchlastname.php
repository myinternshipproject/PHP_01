...
$result=mysql_query("Select * from memberinfo where member_name_last like '".$lname."%'");
...
if($npage >=1)
{
$result=mysql_query("Select * from memberinfo where member_name_last like '".$lname."%' order by member_sl_no asc limit ".(($npage-1)*20).",20"); 
}
else
{
...
for($k=1; $k<=$numlink;$k++)
{
	if($k==$npage)
	{
  echo "<td width=30><form action='searchlastname.php' method='post'><input type='hidden' name='lname' value='".$lname."'><input type='hidden' name='npage' value='".$k."'><input type=submit value='".$k."' class=subdata1></form></td>";
	}
	else
	{
	 echo "<td width=30><form action='searchlastname.php' method='post'><input type='hidden' name='lname' value='".$lname."'><input type='hidden' name='npage' value='".$k."'><input type=submit value='".$k."' class=subdata2></form></td>";	
	}
}
