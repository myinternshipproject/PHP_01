...
for($k=1; $k<=$numlink;$k++)
{
  if($k==$npage)
  {
  echo "<td width=30 bgcolor=#a10090 align=center><a href='showallmember.php?npage=".$k."'>".$k."</a></td>";
  }
  else
  {
  echo "<td width=30 bgcolor=#FFFFFF align=center><a href='showallmember.php?npage=".$k."'>".$k."</a></td>";  
  }
